...
async function run() {
  try {
    ...
    app.post("/addToy", async (req, res) => {
      try {
        const dataGetClient = req.body; //get data from website to server site
        // console.log(dataGetClient);

        const result = await productCollection.insertOne(dataGetClient); // Define the database collection where keep the data
